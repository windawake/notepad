获取查询字段
```
#0  THD::send_result_metadata (this=0x555558ff4bc0, list=0x5555590346e8, flags=5) at /web/mysql-5.7.25/sql/sql_class.cc:4627
#1  0x00005555569cce4b in Query_result_send::send_result_set_metadata (this=0x555559035838, list=..., flags=5)
    at /web/mysql-5.7.25/sql/sql_class.cc:2674
#2  0x00005555569e5172 in JOIN::exec (this=0x555558fe6b58) at /web/mysql-5.7.25/sql/sql_executor.cc:197
#3  0x0000555556a868cc in handle_query (thd=0x555558ff4bc0, lex=0x555558ff6ee0, result=0x555559035838, added_options=0, 
    removed_options=0) at /web/mysql-5.7.25/sql/sql_select.cc:184
#4  0x0000555556a36d95 in execute_sqlcom_select (thd=0x555558ff4bc0, all_tables=0x5555590351f8)
    at /web/mysql-5.7.25/sql/sql_parse.cc:5144
#5  0x0000555556a2ff7a in mysql_execute_command (thd=0x555558ff4bc0, first_level=true)
    at /web/mysql-5.7.25/sql/sql_parse.cc:2816
#6  0x0000555556a37d14 in mysql_parse (thd=0x555558ff4bc0, parser_state=0x7fffeca36530)
    at /web/mysql-5.7.25/sql/sql_parse.cc:5570
#7  0x0000555556a2cc79 in dispatch_command (thd=0x555558ff4bc0, com_data=0x7fffeca36de0, command=COM_QUERY)
    at /web/mysql-5.7.25/sql/sql_parse.cc:1484
#8  0x0000555556a2bb03 in do_command (thd=0x555558ff4bc0) at /web/mysql-5.7.25/sql/sql_parse.cc:1025
#9  0x0000555556b6e228 in handle_connection (arg=0x555558e5ca60)
    at /web/mysql-5.7.25/sql/conn_handler/connection_handler_per_thread.cc:306
#10 0x0000555557258162 in pfs_spawn_thread (arg=0x555558fa2040) at /web/mysql-5.7.25/storage/perfschema/pfs.cc:2190
#11 0x00007ffff75796db in start_thread (arg=0x7fffeca37700) at pthread_create.c:463
#12 0x00007ffff696388f in clone () at ../sysdeps/unix/sysv/linux/x86_64/clone.S:95
